...
export default function BinarySearchVisualizer() {
  ...
  // Build info tabs for bottom panel
  const infoTabs = [
    {
      id: 'explanation',
      label: 'Explanation',
    ...
    },
    {
      id: 'guide',
      label: 'Guide',
      content: <AlgorithmGuide template={currentTemplate} templateKey={templateKey} />,
    },
  ];

  // Add result tab if there's a result
  if (result) {
    infoTabs.push({
      id: 'result',
      label: 'Result',
