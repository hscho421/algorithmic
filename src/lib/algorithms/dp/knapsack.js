...
export const TEMPLATES = {
  knapsack: {
    ...
    code: [
      { line: 'function knapsack(weights, values, capacity):', indent: 0 },
      { line: 'n = weights.length', indent: 1 },
      { line: 'dp = 2D array (n+1) × (capacity+1) filled with 0', indent: 1 },
      { line: '', indent: 0 },
      { line: 'for i = 1 to n:', indent: 1 },
      { line: 'for w = 0 to capacity:', indent: 2 },
      ...
      { line: 'withItem = dp[i-1][w-weights[i-1]] + values[i-1]', indent: 4 },
      { line: 'dp[i][w] = max(dp[i][w], withItem)', indent: 4 },
      { line: '', indent: 0 },
