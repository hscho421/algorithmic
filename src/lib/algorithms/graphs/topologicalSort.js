export const template = {
  ...
  code: [
    { line: 'topologicalSort(graph):', indent: 0 },
    { line: 'inDegree = count incoming edges', indent: 1 },
    { line: 'queue = nodes with inDegree 0', indent: 1 },
    { line: 'result = []', indent: 1 },
    { line: 'while queue not empty:', indent: 1 },
    { line: 'node = queue.dequeue()', indent: 2 },
    { line: 'result.append(node)', indent: 2 },
    { line: 'for neighbor of node:', indent: 2 },
    { line: 'inDegree[neighbor]--', indent: 3 },
    { line: 'if inDegree[neighbor] == 0:', indent: 3 },
