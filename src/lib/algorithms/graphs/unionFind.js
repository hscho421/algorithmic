export const template = {
  ...
  code: [
    ...
    { line: 'def __init__(self, n):', indent: 1 },
    { line: 'self.parent = [i for i in range(n)]', indent: 2 },
    { line: 'self.rank = [0 for _ in range(n)]', indent: 2 },
    { line: '', indent: 0 },
    { line: 'def find(self, x):', indent: 1 },
    { line: 'if self.parent[x] != x:', indent: 2 },
    { line: 'self.parent[x] = self.find(self.parent[x])', indent: 3 },
    { line: 'return self.parent[x]', indent: 2 },
    { line: '', indent: 0 },
    { line: 'def union(self, x, y):', indent: 1 },
    { line: 'root_x = self.find(x)', indent: 2 },
    { line: 'root_y = self.find(y)', indent: 2 },
    { line: 'if root_x == root_y: return', indent: 2 },
    { line: 'if self.rank[root_x] < self.rank[root_y]:', indent: 2 },
    { line: 'self.parent[root_x] = root_y', indent: 3 },
    { line: 'elif self.rank[root_x] > self.rank[root_y]:', indent: 2 },
    { line: 'self.parent[root_y] = root_x', indent: 3 },
    { line: 'else:', indent: 2 },
    { line: 'self.parent[root_y] = root_x', indent: 3 },
    { line: 'self.rank[root_x] += 1', indent: 3 },
  ],
};
