export const template = {
  ...
  code: [
    ...
    { line: 'if node is None:', indent: 1 },
    { line: 'return Node(value)', indent: 2 },
    { line: 'if value < node.value:', indent: 1 },
    { line: 'node.left = insert(node.left, value)', indent: 2 },
    { line: 'elif value > node.value:', indent: 1 },
    { line: 'node.right = insert(node.right, value)', indent: 2 },
    { line: 'return node', indent: 1 },
    { line: '', indent: 0 },
    { line: 'def search(node, value):', indent: 0 },
    { line: 'if node is None: return False', indent: 1 },
