export const template = {
  ...
  code: {
    inorder: [
      { line: 'def inorder(node):', indent: 0 },
      { line: 'if node is None: return', indent: 1 },
      { line: 'inorder(node.left)', indent: 1 },
      { line: 'visit(node)', indent: 1 },
      { line: 'inorder(node.right)', indent: 1 },
    ],
    preorder: [
      { line: 'def preorder(node):', indent: 0 },
      { line: 'if node is None: return', indent: 1 },
      { line: 'visit(node)', indent: 1 },
    ...
    postorder: [
      { line: 'def postorder(node):', indent: 0 },
      { line: 'if node is None: return', indent: 1 },
    ...
    levelorder: [
      { line: 'def levelorder(root):', indent: 0 },
      { line: 'queue = [root]', indent: 1 },
      { line: 'while queue:', indent: 1 },
      { line: 'node = queue.pop(0)', indent: 2 },
      { line: 'visit(node)', indent: 2 },
      { line: 'if node.left: queue.append(node.left)', indent: 2 },
      { line: 'if node.right: queue.append(node.right)', indent: 2 },
    ],
  },
};
