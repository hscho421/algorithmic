export const template = {
  ...
  code: [
    { line: 'def heap_sort(arr):', indent: 0 },
    { line: 'build_max_heap(arr)', indent: 1 },
    { line: 'for end in range(n - 1, 0, -1):', indent: 1 },
    { line: 'arr[0], arr[end] = arr[end], arr[0]', indent: 2 },
    { line: 'sift_down(arr, 0, end)', indent: 2 },
    { line: '', indent: 0 },
    { line: 'def build_max_heap(arr):', indent: 0 },
    { line: 'for i in range((n - 2) // 2, -1, -1):', indent: 1 },
    { line: 'sift_down(arr, i, n)', indent: 2 },
    { line: '', indent: 0 },
    { line: 'def sift_down(arr, i, size):', indent: 0 },
    ...
    { line: 'arr[i], arr[largest] = arr[largest], arr[i]', indent: 2 },
