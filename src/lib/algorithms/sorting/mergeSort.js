export const template = {
  ...
  spaceComplexity: 'O(n)',
  code: [
    { line: 'def merge_sort(arr, l, r):', indent: 0 },
    { line: 'if l >= r: return', indent: 1 },
    { line: 'm = (l + r) // 2', indent: 1 },
    { line: 'merge_sort(arr, l, m)', indent: 1 },
    { line: 'merge_sort(arr, m + 1, r)', indent: 1 },
    { line: 'merge(arr, l, m, r)', indent: 1 },
    { line: '', indent: 0 },
    { line: 'def merge(arr, l, m, r):', indent: 0 },
    ...
    { line: 'arr[k] = left[i]; i += 1', indent: 3 },
    { line: 'else:', indent: 2 },
    { line: 'arr[k] = right[j]; j += 1', indent: 3 },
    { line: 'k += 1', indent: 2 },
