export const template = {
  ...
  code: [
    { line: 'quickSort(arr, lo, hi):', indent: 0 },
    { line: 'if lo >= hi: return', indent: 1 },
    { line: 'pivot = partition(arr, lo, hi)', indent: 1 },
    { line: 'quickSort(arr, lo, pivot - 1)', indent: 1 },
    { line: 'quickSort(arr, pivot + 1, hi)', indent: 1 },
    { line: '', indent: 0 },
    { line: 'partition(arr, lo, hi):', indent: 0 },
    { line: 'pivot = arr[hi]', indent: 1 },
    { line: 'i = lo - 1', indent: 1 },
    { line: 'for j = lo to hi - 1:', indent: 1 },
    { line: 'if arr[j] <= pivot:', indent: 2 },
    { line: 'i++', indent: 3 },
    { line: 'swap arr[i], arr[j]', indent: 3 },
    { line: 'swap arr[i+1], arr[hi]', indent: 1 },
