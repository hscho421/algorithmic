export const TEMPLATES = {
  fixed_max_sum: {
    ...
    inputType: 'array',
    code: [
      { line: 'window_sum = sum(arr[0:k])', indent: 0 },
      { line: 'max_sum = window_sum', indent: 0 },
      { line: 'for r in range(k, n):', indent: 0 },
      { line: 'window_sum += arr[r] - arr[r - k]', indent: 1 },
      { line: 'if window_sum > max_sum:', indent: 1 },
      { line: 'max_sum = window_sum', indent: 2 },
    ],
  },
  min_len_subarray: {
    id: 'min_len_subarray',
    ...
    inputType: 'array',
    code: [
      { line: 'l = 0; total = 0; min_len = float("inf")', indent: 0 },
      { line: 'for r in range(n):', indent: 0 },
      { line: 'total += arr[r]', indent: 1 },
      { line: 'while total >= target:', indent: 1 },
      { line: 'min_len = min(min_len, r - l + 1)', indent: 2 },
      { line: 'total -= arr[l]; l += 1', indent: 2 },
    ],
  },
  longest_unique: {
    id: 'longest_unique',
    ...
    inputType: 'string',
    code: [
      { line: 'l = 0; best = 0; last_seen = {}', indent: 0 },
      { line: 'for r in range(n):', indent: 0 },
      { line: 'if s[r] in last_seen and last_seen[s[r]] >= l: l = last_seen[s[r]] + 1', indent: 1 },
      { line: 'last_seen[s[r]] = r', indent: 1 },
