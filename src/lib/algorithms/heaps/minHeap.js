...
export const template = {
  ...
  code: {
    insert: [
      { line: 'insert(value):', indent: 0 },
      { line: 'heap.push(value)', indent: 1 },
      { line: 'i = heap.length - 1', indent: 1 },
      { line: 'while i > 0:', indent: 1 },
      { line: 'parent = (i - 1) // 2', indent: 2 },
      { line: 'if heap[parent] in order with heap[i]: break', indent: 2 },
      { line: 'swap heap[parent], heap[i]', indent: 2 },
      { line: 'i = parent', indent: 2 },
    ],
    extract: [
      { line: 'extractRoot():', indent: 0 },
      { line: 'if heap is empty: return null', indent: 1 },
      { line: 'root = heap[0]', indent: 1 },
      { line: 'last = heap.pop()', indent: 1 },
      { line: 'if heap not empty: heap[0] = last', indent: 1 },
      { line: 'i = 0', indent: 1 },
      { line: 'while true:', indent: 1 },
      { line: 'left = 2*i + 1, right = 2*i + 2', indent: 2 },
      { line: 'best = i', indent: 2 },
      { line: 'if left in range and heap[left] better:', indent: 2 },
      { line: 'best = left', indent: 3 },
      { line: 'if right in range and heap[right] better:', indent: 2 },
      { line: 'best = right', indent: 3 },
      { line: 'if best == i: break', indent: 2 },
      { line: 'swap heap[i], heap[best]', indent: 2 },
      { line: 'i = best', indent: 2 },
      { line: 'return root', indent: 1 },
    ],
    heapify: [
      { line: 'buildHeap(arr):', indent: 0 },
      { line: 'heap = arr', indent: 1 },
      { line: 'for i = (n-2)//2 down to 0:', indent: 1 },
      { line: 'siftDown(i)', indent: 2 },
    ],
    deleteIndex: [
      { line: 'deleteIndex(i):', indent: 0 },
      { line: 'if i out of range: return', indent: 1 },
      { line: 'swap heap[i], heap[last]', indent: 1 },
      { line: 'heap.pop()', indent: 1 },
      { line: 'if heap[i] higher priority than parent:', indent: 1 },
      { line: 'bubbleUp(i)', indent: 2 },
      { line: 'else:', indent: 1 },
      { line: 'siftDown(i)', indent: 2 },
    ],
    changeKey: [
      { line: 'changeKey(i, value):', indent: 0 },
      { line: 'if i out of range: return', indent: 1 },
